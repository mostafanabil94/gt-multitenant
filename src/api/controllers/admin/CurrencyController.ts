...
export class CurrencyController {
  ...
  public async addCurrency(
    ...
    newCurrency.symbolLeft =
      currencyParameter.symbolLeft !== ""
        ? currencyParameter.symbolLeft
        : undefined;
    newCurrency.symbolRight =
      currencyParameter.symbolRight !== ""
        ? currencyParameter.symbolRight
        : undefined;
  ...
  public async updateCurrency(
    ...
    currency.symbolLeft =
      currencyParam.symbolLeft === undefined
        ? undefined
        : currencyParam.symbolLeft;
    currency.symbolRight =
      currencyParam.symbolRight === undefined
        ? undefined
        : currencyParam.symbolRight;
